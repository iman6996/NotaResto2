 ...
 */
final class Version20200317104608 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT NOT NULL, parent_id INT DEFAULT NULL, message LONGTEXT NOT NULL, rating INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_D2294458B1E7706E (restaurant_id), INDEX IDX_D2294458727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE feedback ADD CONSTRAINT FK_D2294458B1E7706E FOREIGN KEY (restaurant_id) REFERENCES restaurant (id)');
        $this->addSql('ALTER TABLE feedback ADD CONSTRAINT FK_D2294458727ACA70 FOREIGN KEY (parent_id) REFERENCES feedback (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE feedback DROP FOREIGN KEY FK_D2294458727ACA70');
        $this->addSql('ALTER TABLE feedback DROP FOREIGN KEY FK_D2294458B1E7706E');
